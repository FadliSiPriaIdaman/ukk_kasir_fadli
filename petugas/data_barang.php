...
<div class="card mt-2">
    <div class="card-body ">
        ...
        <?php
            echo "<style>
                body {background-image: url('../assets/pink-and-orange-gradient-geometric-banner-vector.jpg');}
            </style>";
        ?>
            ...
            <tbody>
                ...
                while($d = mysqli_fetch_array($data)){
                    ...
                    <tr>
                        ...
                        <td>
                            <button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#edit-data<?php echo $d['ProdukID']; ?>">
                                Edit
                            </button>
