...
?>
            <div class="card mt-2">
                <div class="card-body ">
                    <?php
                        echo "<style>
                            body {background-image: url('../assets/wp6198703.png');}
                        </style>";
                     ?>
                ...
                <div class="card-body">
                   ...
                   <table class="table">
                    ...
                    <?php 
                        include '../koneksi.php';
                        $no = 1;
                        $data = mysqli_query($koneksi,"SELECT * FROM pelanggan INNER JOIN penjualan ON pelanggan.
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#edit-data<?php echo $d['PelangganID']; ?>">
                                    Edit
                                </button>
            ...
            <!-- Modal Tambah Data-->
                ...
                <div class="modal-dialog">
                    ...
                    <form action="proses_pembelian_barang.php" method="post">
                        <div class="modal-body">
                                <div class="form-group">
