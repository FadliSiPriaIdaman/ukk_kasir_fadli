...
<div class="card mt-2">
    ...
    <?php
echo "<style>
    body {background-image: url('../assets/vector-abstract-background-texture-design.jpg');}
</style>";
   ?>
                ...
                while($d = mysqli_fetch_array($data)){
                    ...
                    <?php } ?>
                        ...
                        <td>
                            ...
                            <button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#edit-data<?php echo $d['id_petugas']; ?>">
                                Edit
                            </button>
                            <?php 
